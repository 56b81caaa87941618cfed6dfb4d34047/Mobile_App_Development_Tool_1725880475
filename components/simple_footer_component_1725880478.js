...
<template>
    <footer id="footer-section" style="min-height: 630px"  class="flex-1 bg-white dark:bg-gray-800">
        <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="flex">
                <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                    © 2023 AppCraft. Empowering developers to build amazing mobile applications.
                </div>
            </div>
        </div>
    </footer>
