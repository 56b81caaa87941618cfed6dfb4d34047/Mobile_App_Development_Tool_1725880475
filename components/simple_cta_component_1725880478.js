...
-->
<template>
    <section id="cta-component" style="min-height: 70px"  class="bg-gray-50 dark:bg-gray-800 flex-1">
            ...
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                        Transform your ideas into powerful mobile apps with our intuitive development platform
                    </p>
                </div>
